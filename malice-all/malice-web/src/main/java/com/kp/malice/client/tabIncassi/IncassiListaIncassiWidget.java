...
public class IncassiListaIncassiWidget extends Composite implements IsWidget {

    private static ListaIncassiUiBinder uiBinder = GWT.create(ListaIncassiUiBinder.class);

    interface ListaIncassiUiBinder extends UiBinder<Widget, IncassiListaIncassiWidget> {
    }
    ...
    public IncassiListaIncassiWidget(int pageSize) {
