 ...
 */
public class ToolbarRicercaStatistiche extends Composite {
	...
	interface ToolbarRicercaStatisticheUiBinder extends UiBinder<Widget, ToolbarRicercaStatistiche> {
	}
	...
	public ToolbarRicercaStatistiche() {
