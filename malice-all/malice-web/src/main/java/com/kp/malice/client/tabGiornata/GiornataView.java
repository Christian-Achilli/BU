...
import com.kp.malice.client.ui.commonWidgets.ScritturaContabileWidget;
...
public class GiornataView extends Composite implements IGiornataViewDisplay {

    private static IncassiViewUiBinder uiBinder = GWT.create(IncassiViewUiBinder.class);

    interface IncassiViewUiBinder extends UiBinder<Widget, GiornataView> {
    }

    private IGiornataViewDisplay.Listener listener;

    @UiField
    ScritturaContabileWidget scritturaContabile;
    @UiField
    GiornataAggregatiWidget incassiAggregati;
    ...
    public IGiornataViewDisplay.Listener getListener() {
        return listener;
    }

    @Override
    public void setListener(IGiornataViewDisplay.Listener listener) {
