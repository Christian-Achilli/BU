...
public class MainAgenteLayout extends LayoutPanel {
    ...
    public final static int BENVENUTO_TAB = 0;
    private final static int TITOLI_TAB = 1;
    private final static int INCASSI_TAB = 2;
    private final static int CHIUSURE_TAB = 3;
    private final static int STATISTICHE_TAB = 4;
