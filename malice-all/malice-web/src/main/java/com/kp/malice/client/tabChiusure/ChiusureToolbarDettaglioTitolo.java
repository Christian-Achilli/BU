...
public class ChiusureToolbarDettaglioTitolo extends Composite {

    private static ToolbarChiusureDettaglioTitoloUiBinder uiBinder = GWT
            .create(ToolbarChiusureDettaglioTitoloUiBinder.class);

    interface ToolbarChiusureDettaglioTitoloUiBinder extends UiBinder<Widget, ChiusureToolbarDettaglioTitolo> {
    }
...
//    Button downloadButton;
    ...
    public ChiusureToolbarDettaglioTitolo() {
