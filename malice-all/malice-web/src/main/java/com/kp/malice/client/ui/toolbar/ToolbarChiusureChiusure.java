...
import com.kp.malice.client.ui.widget.ConfermaAnnullaNotaChiusureWidget;
 ...
 */
public class ToolbarChiusureChiusure extends Composite {

    private static ToolbarChiusuraDelMeseUiBinder uiBinder = GWT.create(ToolbarChiusuraDelMeseUiBinder.class);

    interface ToolbarChiusuraDelMeseUiBinder extends UiBinder<Widget, ToolbarChiusureChiusure> {
    }
    ...
    public ToolbarChiusureChiusure() {
