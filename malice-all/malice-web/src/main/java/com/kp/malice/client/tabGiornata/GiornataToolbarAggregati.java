...
public class GiornataToolbarAggregati extends Composite {

    private static ToolbarScritturaContabileUiBinder uiBinder = GWT.create(ToolbarScritturaContabileUiBinder.class);

    interface ToolbarScritturaContabileUiBinder extends UiBinder<Widget, GiornataToolbarAggregati> {
    }
    ...
    public GiornataToolbarAggregati() {
