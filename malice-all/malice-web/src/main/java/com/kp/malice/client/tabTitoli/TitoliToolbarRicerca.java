...
import com.kp.malice.client.ui.commonWidgets.DoppioCalendarioWidget;
 ...
 */
public class TitoliToolbarRicerca extends Composite {

    private static ToolbarRicercaTitoliUiBinder uiBinder = GWT.create(ToolbarRicercaTitoliUiBinder.class);

    interface ToolbarRicercaTitoliUiBinder extends UiBinder<Widget, TitoliToolbarRicerca> {
    }
