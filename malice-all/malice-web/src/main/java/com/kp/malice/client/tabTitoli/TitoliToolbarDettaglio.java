...
import com.kp.malice.client.ui.commonWidgets.ConfermaAnnullaNotaWidget;
import com.kp.malice.client.ui.commonWidgets.IncassoForm;
import com.kp.malice.client.ui.commonWidgets.RecuperoWidget;
import com.kp.malice.client.ui.commonWidgets.RevocaAnnulloWidget;
import com.kp.malice.client.ui.commonWidgets.StornaTitoloWidget;
 ...
 */
public class TitoliToolbarDettaglio extends Composite {

    private static ToolbarDettaglioTitoloUiBinder uiBinder = GWT.create(ToolbarDettaglioTitoloUiBinder.class);

    interface ToolbarDettaglioTitoloUiBinder extends UiBinder<Widget, TitoliToolbarDettaglio> {
    }
