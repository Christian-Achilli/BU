...
import com.kp.malice.client.amministrazione.ContactDatabase.Category;
import com.kp.malice.client.amministrazione.ContactDatabase.ContactInfo;
...
public class ContactTreeViewModel implements TreeViewModel {
    ...
    public ContactTreeViewModel(final SelectionModel<ContactInfo> selectionModel) {
        ...
        hasCells.add(new HasCell<ContactInfo, ContactInfo>() {
            ...
            private ContactCell cell = new ContactCell(MaliceResources.INSTANCE.head());
    ...
    public <T> NodeInfo<?> getNodeInfo(T value) {
        if (value == null) {
            ...
            return new DefaultNodeInfo<Category>(categoryDataProvider,
                    new CategoryCell(MaliceResources.INSTANCE.head()));
            ...
            return new DefaultNodeInfo<LetterCount>(new ListDataProvider<LetterCount>(orderedCounts),
                    new LetterCountCell());
            ...
            List<ContactInfo> contacts = ContactDatabase.get().queryContactsByCategoryAndFirstName(count.category,
                    count.firstLetter + "");
            ListDataProvider<ContactInfo> dataProvider = new ListDataProvider<ContactInfo>(contacts,
    ...
    static class ContactCell extends AbstractCell<ContactInfo> {
        ...
        @Override
        public void render(com.google.gwt.cell.client.Cell.Context context, ContactInfo value, SafeHtmlBuilder sb) {
