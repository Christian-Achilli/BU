...
public class IncassiActivity extends AbstractActivity implements IIncassiViewDisplay.Listener,
        TitoloUpdatedEvent.Handler {

    private final IIncassiViewDisplay display;
    ...
    @Inject
    public IncassiActivity(IIncassiViewDisplay display, EventBus eventBus, Provider<ServiziPortale> serviziProvider) {
    ...
    public IncassiActivity withPlace(final Place place) {
