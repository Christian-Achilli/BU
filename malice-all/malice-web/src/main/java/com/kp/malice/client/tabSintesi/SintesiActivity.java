...
public class SintesiActivity extends AbstractActivity implements ISintesiViewDisplay.Listener { // VisualizzaStatisticheEvent.Handler,

	private final ISintesiViewDisplay display;
	...
	@Inject
	public SintesiActivity(ISintesiViewDisplay display, EventBus eventBus, Provider<ServiziPortale> serviziProvider) {
	...
	public SintesiActivity withPlace(final Place place) {
		return this;
	}
