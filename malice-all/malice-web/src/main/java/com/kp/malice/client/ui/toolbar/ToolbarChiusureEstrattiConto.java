...
public class ToolbarChiusureEstrattiConto extends Composite {

    private static ToolbarChiusureEstrattiContoUiBinder uiBinder = GWT
            .create(ToolbarChiusureEstrattiContoUiBinder.class);

    interface ToolbarChiusureEstrattiContoUiBinder extends UiBinder<Widget, ToolbarChiusureEstrattiConto> {
    }
    ...
    public ToolbarChiusureEstrattiConto() {
