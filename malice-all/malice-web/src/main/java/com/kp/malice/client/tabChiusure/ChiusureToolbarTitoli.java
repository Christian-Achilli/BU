...
public class ChiusureToolbarTitoli extends Composite {

    private static ToolbarChiusureEstrattiContoUiBinder uiBinder = GWT
            .create(ToolbarChiusureEstrattiContoUiBinder.class);

    interface ToolbarChiusureEstrattiContoUiBinder extends UiBinder<Widget, ChiusureToolbarTitoli> {
    }
