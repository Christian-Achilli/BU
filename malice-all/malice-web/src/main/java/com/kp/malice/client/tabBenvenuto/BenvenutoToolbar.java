 ...
 */
public class BenvenutoToolbar extends Composite {

    private static ToolbarRiepilogoMensileTitoliUiBinder uiBinder = GWT
            .create(ToolbarRiepilogoMensileTitoliUiBinder.class);

    interface ToolbarRiepilogoMensileTitoliUiBinder extends UiBinder<Widget, BenvenutoToolbar> {
    }
