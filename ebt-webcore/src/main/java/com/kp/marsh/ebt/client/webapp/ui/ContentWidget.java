...
public abstract class ContentWidget extends LazyPanel implements HasValueChangeHandlers<String> {
    ...
    public void getRawSource(final String filename, final Callback<String> callback) {
        if (rawSource.containsKey(filename)) {
            ...
            sendSourceRequest(rc, "gwtShowcaseSource/raw/" + filename + ".html");
        }
    }
    ...
    public void getStyle(final Callback<String> callback) {
        if (styleDefs != null) {
            ...
            String srcPath = "gwtShowcaseSource/css/" + "clean";
    ...
    public void getSource(final Callback<String> callback) {
        if (sourceCode != null) {
            ...
            String className = this.getClass().getName();
            className = className.substring(className.lastIndexOf(".") + 1);
            sendSourceRequest(rc, "gwtShowcaseSource/java/" + className + ".html");
        }
    }
