...
@Entity
@Table(name="M_ACTUALS")
public class MActuals implements java.io.Serializable {
	...
	public MActuals(String annoContabile, String idAeCgruppo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MActuals))
			return false;
		MActuals castOther = (MActuals) other;
